...
def boo0(value,row,db):
    rows = db((db.Produits_chimiquesConseils_de_prudence.Produits_chimiques == row.id)&(db.Produits_chimiquesConseils_de_prudence.Conseils_de_prudence == db.Conseils_de_prudence.Codes)).select(db.Conseils_de_prudence.ALL)
