...
'Add record to database': 'Ajouter Enregistrement dans la base',
...
'Enter a valid URL': 'Entrez une adresse valide',
...
'HTML': 'HTML',
'HTML export of visible columns': 'HTML export des colonnes visibles',
'Id': 'Id',
'import': 'importer',
...
'No records found': "Pas d'enregistrements trouvés",
...
'Search': 'Rechercher',
'Select columns to create a plot': 'Sélectionnez les colonnes pour générer le graphique',
'Seller Id': 'Seller Id',
'Semantic': 'Sémantique',
'Services': 'Services',
'Sheet': 'Feuille',
...
'This email already has an account': 'Cet email a déjà un compte',
...
'Videos': 'Vidéos',
'View': 'Présentation',
'View %(entity)s': 'Vue %(entity)s',
'Web2py': 'Web2py',
'Welcome': 'Bienvenue',
'Welcome %s': 'Bienvenue %s',
'Welcome to web2py': 'Bienvenue à web2py',
'Welcome to web2py!': 'Bienvenue à web2py!',
'Welcome to your new IINS App!': 'Bienvenue dans votre nouvelle application IINS!',
